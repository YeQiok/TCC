    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="./img/Banner2.jpg" class="d-block w-100" alt="..." height="500px">
        </div>
        <div class="carousel-item">
          <img src="./img/Banner3.jpg" class="d-block w-100" alt="..." height="500px">
        </div>
      </div>
            ...
            <div id="produtos" class="col-md-12 produtos">
                ...
                <div class="card" style="width: 18rem;">
                    <img src="./img/torta.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Torta Banoffee</h5><br /></br />
                            <a id="negrito">R$ 50,00</a><p class="card-text"> em até 3x 16,67 no cartão</p><br />
                ...
                <div id="card">
                    <div class="card" style="width: 18rem;">
                        <img src="./img/torta.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Torta Cheesecake de Amora</h5><br />
                                <a id="negrito">R$ 74,00</a><p class="card-text">  em até 3x 24,67 no cartão</p><br />
                                <a href="#" class="btn btn-primary">Comprar</a>
                            </div>
                    </div>
                </div>     
                    ...
                    <img src="./img/torta.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Torta Cheesecake de Frutas Vermelhas</h5><br />
                            <a id="negrito">R$ 74,00</a><p class="card-text">em até 3x 24,67 no cartão</p><br />
                            <a href="#" class="btn btn-primary">Comprar</a>
                        </div>
                </div>
...
<div class="container text-center text-md-left">
  ...
  <div class="row">
    ...
    <div class="col-md-2 mx-auto">
      ...
      <!-- Links -->
      <h5 id="footer-text"  class="font-weight-bold text-uppercase mt-3 mb-4 ">Minha Conta</h5>
    ...
    <div class="col-md-2 mx-auto">
      ...
      <!-- Links -->
      <h5 id="footer-text" class="font-weight-bold text-uppercase mt-3 mb-4">Formas de Pagamento</h5>

      <ul class="list-unstyled">
        <li>
          <a id="footer-text" href="#!">Link 1</a>
        </li>
        <li>
          <a id="footer-text" href="#!">Link 2</a>
        </li>
      </ul>
    ...
    <div class="col-md-2 mx-auto">
      ...
      <!-- Links -->
      <h5 id="footer-text" class="font-weight-bold text-uppercase mt-3 mb-4">Redes Sociais</h5>
